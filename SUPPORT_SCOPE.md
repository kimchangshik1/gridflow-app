...
- monitor 운영 관측 경로
- runtime emergency stop evidence와 operator procedure note
...
- emergency control은 Grid/DCA pause/resume verified path와 runtime/operator safeguard를 섞지 않습니다.
- dedicated backend emergency release endpoint나 full-system one-click recovery를 기본 지원 범위처럼 설명하지 않습니다.
